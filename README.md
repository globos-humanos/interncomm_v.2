...
1.  **Intern adds patient**
    
2.  Patient is visible immediately to the unit
    
3.  PG approval happens asynchronously
    
4.  Tasks and chats continue regardless
    
5.  PG discharges patient when care is complete
    
6.  Patient is archived (removed from active views)
...
This project is currently **private / internal-use only**.Licensing and distribution decisions are pending real-world validation.
...
It exists because real problems were felt first —and solved carefully, one decision at a time.
